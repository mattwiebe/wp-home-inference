...
* Fix the WordPress.org deployment slug used by release automation.

= 0.6.0 =

* Add WordPress.org release deployment and plugin directory assets.
...
* Update plugin slugs, text domain, option names, handles, and packaged paths to use the `mwlai` prefix for WordPress.org compliance.

= 0.4.1 =

* Keep the text domain aligned with the packaged plugin slug.
...
* Rename the plugin to "MW Local AI Connector" with a matching slug and text domain.
* Move the main plugin file to `mw-local-ai-connector.php`.
