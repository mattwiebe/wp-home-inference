...
namespace Mattwiebe\LocalAiConnector\Metadata;
 ...
 * }
 */
class ActualComputerModelMetadataDirectory extends AbstractOpenAiCompatibleModelMetadataDirectory {
	...
	protected function parseResponseToModelMetadataList( Response $response ): array {
		...
		if ( ! isset( $responseData['data'] ) || ! $responseData['data'] ) {
			throw ResponseException::fromMissingData( 'Actual Computer', 'data' );
		}
